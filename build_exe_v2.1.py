#!/usr/bin/env python3
"""
Build script to convert AES-256-CBC GUI v2.2 to executable
...
def build_exe():
    ...
    print("="*50)
    print("\nExecutable location: dist/AES256-CBC-Tool-v2.2.exe")
    print("\n© 2026 @3bHussein. All rights reserved.")

if __name__ == "__main__":
    print("AES-256-CBC Tool v2.2 Builder")
    print("© 2026 @3bHussein")
    print("="*50)
